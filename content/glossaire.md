...
- **LMP (Loueur en Meublé Professionnel)** <a name="LMP"></a>  
...
- **Nue-propriété**  
Elle est égale à la différence entre la [pleine propriété](#pleinepropriete) et l’[usufruit](#usufruit). Le nu-propriétaire détient le principal ou le capital d’un bien sans en percevoir les fruits et sans avoir le droit de l’utiliser. Au terme de l’usufruit dans le cas d’un usufruit temporaire, ou à la mort de l’usufruitier dans le cas d’un usufruit viager, le nu-propriétaire acquiert la pleine propriété du bien.
...
- **Pleine propriété** <a name="pleinepropriete"></a>  
...
Contrat particulier qui s’impose aux copropriétaires. Il est obligatoire et doit déterminer au minimum la destination (l’usage) de l’immeuble (habitation, commerciale ou les deux), les parties communes et privatives, les règles relatives à l’administration des parties communes et l’état de répartition des charges. S’il n’existe pas, ce sont des dispositions de la [loi du 10 juillet 1965](https://www.legifrance.gouv.fr/affichTexte.do?cidTexte=LEGITEXT000006068256) fixant le statut de la copropriété des immeubles bâtis, qui s’appliquent.

- **Rendement (action)**  <a name="rendement"></a> (<img src="/img/usa.png" alt="drawing" style="width:16px;"/>: [Yield](#yield))  
...
[OPCVM](#OPCVM) immobilier qui acquiert et gère un patrimoine immobilier pour le compte des associés. Il existe des sociétés de rendement (qui distribuent des revenus) et des sociétés de valorisation (qui capitalisent).
